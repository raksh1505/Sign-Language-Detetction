...
min_detection_confidence = 0.3  #@param {type:"slider", min:0, max:1, step:0.01}
min_tracking_confidence  = 0.3  #@param {type:"slider", min:0, max:1, step:0.01}

MODEL_PATH = "E:\Active Projects\SignLanguageDetection"
...
def recognize_gesture(image, results, numberMode, model_letter_path, model_number_path):
    ...
    print("Models loaded successfully in recognize_gesture")
